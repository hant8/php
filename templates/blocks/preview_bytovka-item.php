<div class="preview_bytovka-item">
    <div class="preview_bytovka-main">
        ...
        <div class="preview_bytovka-content"><a class="preview_bytovka-heading" href="#"><? echo $bytovkaTitle; ?></a>
            <div class="preview_bytovka-gabarits"><? echo $bytovkaSize; ?></div>
            ...
            <div class="preview_bytovka-order">
                <div class="preview_bytovka-price">Цена: <span><? echo $bytovkaPrice; ?></span></div>
