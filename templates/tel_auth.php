      ...
      <main class="content__main">
        ...
        <form class="form" action="auth.php" method="post" autocomplete="off">
          <div class="form__row">
            ...
            <input class="form__input <? echo isset($errors['errorEmail']) || isset($errors['errorNoEmail'])? ' form__input--error' : ''; ?>" type="text" name="email" id="email" value="" placeholder="Введите e-mail" minlength="5">
            <?php
          ...
          <div class="form__row">
            ...
            <input class="form__input <? echo isset($errors['errorPassword']) ? ' form__input--error' : ''; ?>" type="password" name="password" id="password" value="" placeholder="Введите пароль" minlength="5">
            <?php
            if (isset($errors['errorPassword'])) {
              echo "<p class = 'form__message'>{$errors['errorPassword']}</p>";
              unset($errors['errorPassword']);
            }
            if (isset($errors['errorValid'])) {
              echo "<p class = 'form__message'>{$errors['errorValid']}</p>";
              unset($errors['errorValid']);
            }
            ?>
          </div>
